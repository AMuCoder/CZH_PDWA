...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    if (touch) {
        ...
        for (int i=0; i<buttonArray.count; i++) {
            Gesture1PasswordButton * buttonTemp = ((Gesture1PasswordButton *)[buttonArray objectAtIndex:i]);
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    for (int i=0; i<touchesArray.count; i++) {
        ...
        Gesture1PasswordButton * buttonTemp = ((Gesture1PasswordButton *)[buttonArray objectAtIndex:selection]);
